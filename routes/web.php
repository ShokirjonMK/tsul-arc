...
//    Route::get('index/{id}', 'DepartmentController@index')->name('department.index');
    ...
    //staff
    Route::resource('academic-degree', 'AcademicDegreeController');
    Route::resource('staff', 'StaffController');
    Route::resource('staff-command', 'StaffCommandController');
    Route::resource('command-type', 'CommandTypeController');
    ...
    Route::delete('staff/relative/{id}', 'StaffController@relative_destroy')->name('staff.relative.destroy');
    Route::post('staff/diplom/', 'StaffController@diplom')->name('staff.diplom');
    Route::delete('staff/diplom/{id}', 'StaffController@diplom_destroy')->name('staff.diplom.destroy');
