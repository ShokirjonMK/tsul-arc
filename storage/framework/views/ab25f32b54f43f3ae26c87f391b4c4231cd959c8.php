				...
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-header">
							...
							<form action="<?php echo e(route('academic-degree.update' , ['academic_degree' => $item->id])); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH /var/www/archive/resources/views/admin/pages/academic_degrees/editmodal.blade.php ENDPATH**/ ?>