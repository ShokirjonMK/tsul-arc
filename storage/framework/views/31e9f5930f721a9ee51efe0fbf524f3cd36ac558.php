									...
									<div class="modal-content">
										<div class="modal-body pd-5">
											<div class="img-container">
													<?php if(isset($department_show)): ?><iframe src="<?php echo e($department_show->order_file); ?>" width="100%" height="500px">
													</iframe>
                                                    <?php endif; ?>
											</div>
										</div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/archive/resources/views/admin/pages/department/index.blade.php ENDPATH**/ ?>