                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td> <?php if(isset($item->room)): ?>
                                            ...
                                            <?php endif; ?> </td>
                                        <td class="last-td">
                                            <a class="p-2" href="<?php echo e(route('student.show', ['student' => $item->id])); ?>"><i
                                                    class="dw dw-eye"></i></a>
                                            <a class="p-2" href="<?php echo e(route('student.edit', ['student' => $item->id])); ?>"><i
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tsul\tsul-archive\tsul-archive\resources\views/mk/pages/student/index.blade.php ENDPATH**/ ?>