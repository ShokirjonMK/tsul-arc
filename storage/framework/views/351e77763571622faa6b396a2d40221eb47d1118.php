                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                        <div class="pd-20 card-box height-100-p">
                            <div class="profile-photo">
                                <a href="<?php echo e(route('staff.edit', ['staff' => $data->id])); ?>" class="edit-avatar"><i
                            ...
                            <p class="text-center text-muted font-14"><?php echo e(date("d-m-Y", strtotime($data->birthday))); ?>
                                ...
                                | <?php if($data->gender==1): ?><?php echo e('M'); ?><?php else: ?><?php echo e('F'); ?><?php endif; ?> | <?php echo e($data->nationality->name); ?>  </p>
                            <div class="profile-info">
                                <h5 class="mb-20 h5 text-blue">Asosiy ma'lumotlar: <i
                                        class="icon-copy dw dw-notepad-1"></i> <?php echo e($data->table_number); ?></h5>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <form autocomplete="off" id="fire_staff"
                                                                  action="<?php echo e(route('staff.fire_staff')); ?>" method="post"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <select class="selectpicker form-control"
                                                                            ...
                                                                            <?php $__currentLoopData = $is_worker_now_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $is_worker_now): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option
                                                                                    value="<?php echo e($is_worker_now->department_id); ?>"><?php if($is_worker_now->boss): ?>
                                                                                        + <?php endif; ?> <?php echo e($is_worker_now->department->name); ?>

                                                                                    || <?php echo e($is_worker_now->position); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <form autocomplete="off" id="get_staff"
                                                                  action="<?php echo e(route('staff.get_staff')); ?>" method="post"
                                                                  enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <select class="selectpicker form-control"
                                                                            ...
                                                                            <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departmentOne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option
                                                                                    value="<?php echo e($departmentOne->id); ?>"><?php echo e($departmentOne->name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Manzil:</span>
                                    <?php echo e($data->country->name); ?> | <?php echo e($data->region->name); ?> | <?php echo e($data->area->name); ?>
                                ...
                                <li>
                                    ...
                                    <p>Buyruq sanasi: <?php echo e($data->begin_at); ?></p>
                                    <p>Buyruq raqami: <?php echo e($data->command_number); ?></p>
                                    <p>Lavozimi: <?php echo e($data->position); ?></p>
                                </li>
                                <li>
                                    <span>Mehnat shartnomasi bekor qilingan buyruq:</span>
                                    <p>Buyruq sanasi: <?php echo e($data->end_at); ?></p>
                                    <p>Buyruq raqami: <?php echo e($data->end_command_number); ?></p>
                                </li>
                            ...
                            <div class="tab height-100-p">
                                <ul class="nav nav-tabs customtab" role="tablist">
                                    ...
                                    <a class="btn btn-lg btn-primaryk" data-bgcolor="#3b5998" data-color="#ffffff"
                                       href="<?php echo e(route('pdf_for_staff', ['id'=>$data->id])); ?>" role="tab"> <span
                                                ...
                                                <div class="profile-timeline-list">
                                                    <ul>
                                                        <?php $__currentLoopData = $relative; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relativeOne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <div
                                                                    class="date"><?php echo e($relativeOne->relatives_type->name); ?></div>
                                                                <div
                                                                    class="task-name"> <?php echo e($relativeOne->full_name); ?></div>
                                                                <p><?php echo e($relativeOne->birthday); ?> <?php echo e($relativeOne->country->name); ?>

                                                                    <?php if($relativeOne->region_id): ?><?php echo e($relativeOne->region->name); ?>
                                                                ...
                                                                <span class="text-danger delete-relative-button"
                                                                      itemid=<?php echo e('deleteformrelative'.$relativeOne->id); ?> style="cursor:
                                                                      pointer"> <i class="fa fa-trash"></i>  </span>

                                                                <form class="deleteformrelative<?php echo e($relativeOne->id); ?>"
                                                                      action="<?php echo e(route('staff.relative.destroy' , ['id' => $relativeOne->id])); ?>"
                                                                      method="post">
                                    ...
                                    <div class="tab-pane fade show " id="commands" role="tabpanel">
                                        <div class="pd-20">
                                            ...
                                            <div class="profile-timeline">
                                                <div class="profile-timeline-list">
                                                    <ul>
                                                        <?php $__currentLoopData = $data->commands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $command): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <div class="date"><?php echo e($command->date); ?></div>
                                                                <div
                                                                    class="task-name"> <?php echo e($command->command_type->name); ?></div>
                                                                <p><?php echo e($command->name); ?></p>
                                                                <p><?php echo e($command->description); ?></p>
                                                                <span class="text-danger delete-command-button"
                                                                      itemid="<?php echo e('deleteformcommand'.$command->id); ?>"
                                                                      style="cursor: pointer"> <i
                                                                        class="fa fa-trash"></i>  </span>

                                                                <form class="deleteformcommand<?php echo e($command->id); ?>"
                                                                      action="<?php echo e(route('staff-command.destroy' , ['staff_command' => $command->id])); ?>"
                                                                      method="post">
                                                                    <?php echo e(csrf_field()); ?>
                                ...
                                <?php echo $__env->make('admin.pages.staff.modals.command_create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <select class="selectpicker form-control"
                                                                                ...
                                                                                <?php $__currentLoopData = $RelarivesType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $RelarivesTypeOne): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        value="<?php echo e($RelarivesTypeOne->id); ?>"><?php echo e($RelarivesTypeOne->name1); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-6" id="inputhide1">
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option
                                                                                            <?php if(old('region_id') == $region->id): ?> selected
                                                ...
                                                <div class="profile-timeline-list">
                                                    <ul>
                                                        <?php $__currentLoopData = $education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="diplomaaa">
                                                                <div
                                                                    class="date"><?php echo e($education_one->diplom_issued_date); ?> </div>
                                                                <div
                                                                    class="task-name"> <?php echo e($education_one->university->name); ?> </div>
                                                                <p><?php echo e($education_one->specialization); ?>

                                                                    <br>
                                                                    <?php echo e($education_one->diplom_seria); ?>

                                                                    | <?php echo e($education_one->diplom_number); ?>

                                                                    
                                                                </p>
                                                                <div class="task-time"><?php echo e($education_one->address); ?></div>
                                                                <div
                                                                    class="task-time"><?php echo e($education_one->diplom_types->name); ?></div>
                                                                <span class="text-danger delete-button"
                                                                      itemid=<?php echo e('deleteform'.$education_one->id); ?> style="cursor:
                                                                      pointer"> <i class="fa fa-trash"></i>  </span>

                                                                <form class="deleteform<?php echo e($education_one->id); ?>"
                                                                      action="<?php echo e(route('staff.diplom.destroy' , ['id' => $education_one->id])); ?>"
                                                                      method="post">
                                                                    <?php echo e(csrf_field()); ?>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <form autocomplete="off" id="diplom_form"
                                                                      action="<?php echo e(route('staff.diplom')); ?>" method="post"
                                                                      enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                                    <input type="hidden" name="id"
                                                                           value="<?php echo e($data->id); ?>">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <select class="selectpicker form-control"
                                                                                ...
                                                                                <?php $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        value="<?php echo e($university_one->id); ?>"><?php echo e($university_one->name); ?></option>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select
                                                                                    ...
                                                                                    <?php $__currentLoopData = $diplom_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diplom_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option
                                                                                            value="<?php echo e($diplom_type->id); ?>"><?php echo e($diplom_type->name); ?></option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <div class="profile-timeline-list">
                                                    <ul>
                                                        <?php $__currentLoopData = $work_places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work_places_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="diplomaaa">
                                                                <div class="date"><b><?php echo e($work_places_one->start_time); ?>

                                                                        dan <?php echo e($work_places_one->end_time); ?> gacha</b>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $inactivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inactivity_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="diplomaaa">
                                                                ...
                                                                <div
                                                                    class="task-name"> <?php echo e($inactivity_one->inactivity_type->name); ?></div>
                                                                <p><?php echo e($inactivity_one->name); ?></p>
                                                                <div
                                                                    class="task-time"><?php echo e($inactivity_one->description); ?></div>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select
                                                                                    ...
                                                                                    <?php $__currentLoopData = $inactivity_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inactivity_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option
                                                                                            value="<?php echo e($inactivity_type->id); ?>"><?php echo e($inactivity_type->name); ?></option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $qualification_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification_info_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="diplomaaa">
                                                                <div class="date"></div>
                                                                <div
                                                                    class="task-name"><?php echo e($qualification_info_one->start_date); ?>

                                                                    | <?php echo e($qualification_info_one->end_date); ?></div>
                                                                <p><?php echo e($qualification_info_one->name); ?></p>
                                                                <div
                                                                    class="task-time"><?php echo e($qualification_info_one->description); ?></div>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $mukofot_staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mukofot_staff_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="diplomaaa">
                                                                ...
                                                                <div
                                                                    class="task-name"><?php echo e($mukofot_staff_one->mukofot_type->name); ?></div>
                                                                <p><?php echo e($mukofot_staff_one->name); ?></p>
                                                                <div
                                                                    class="task-time"><?php echo e($mukofot_staff_one->description); ?></div>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                                                            ...
                                                                            <div class="col-md-8" style="">
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <?php $__currentLoopData = $mukofot_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mukofot_type_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option
                                                                                            <?php if((old('mukofot_type_id') == $mukofot_type_one->id)): ?> selected
                                                                                            <?php endif; ?> value="<?php echo e($mukofot_type_one->id); ?>"><?php echo e($mukofot_type_one->name); ?></option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-md-4"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/archive/resources/views/admin/pages/staff/show.blade.php ENDPATH**/ ?>