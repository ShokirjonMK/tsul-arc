	...
	<div class="modal-content">
		<div class="modal-body text-center font-18">
			...
			<div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
				...
				<div class="col-6">
				<form method="Post" action="<?php echo e(route('university.update',$item->id)); ?>">
...
</div><?php /**PATH D:\tsul\tsul-archive\tsul-archive\resources\views/admin/pages/university/delete.blade.php ENDPATH**/ ?>