				...
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-header">
							...
							<form  action="<?php echo e(route('command-type.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH /var/www/archive/resources/views/admin/pages/command_type/createmodal.blade.php ENDPATH**/ ?>