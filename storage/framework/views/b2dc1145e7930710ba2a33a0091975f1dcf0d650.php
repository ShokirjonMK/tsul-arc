            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="wizard-content">
                        <form autocomplete="off" action="<?php echo e(route('staff.update',['staff'=>$data->id])); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="country_id">
                                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php if((old('country_id') == $country->id) || $data->counrty_id == $country->id || ($country->code == "UZ")): ?> selected
                                                                <?php endif; ?> value="<?php echo e($country->id); ?> e"><?php echo e($country->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="region_id">
                                                        <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php if(old('region_id') == $region->id || $data->region_id == $region->id): ?> selected
                                                    ...
                                                    <select class="form-control" name="area_id">
                                                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($area->id == $data->area_id): ?>
                                                                <option selected
                                                                        value="<?php echo e($area->id); ?>"><?php echo e($area->name); ?></option>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input class="form-control" name="birth_address" type="text"
                                                   value="<?php echo e(old('birth_address')?old('birth_address'):$data->birth_address); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="nationality_id">
                                                <?php $__currentLoopData = $nationalities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nationality): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('nationality_id') == $nationality->id || $data->nationality_id == $nationality->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="gender">
                                                ...
                                                <option value="1" <?php if($data->gender==1): ?> selected="true" <?php endif; ?>>Erkak
                                                </option>
                                                <option value="0" <?php if($data->gender==0): ?> selected="true" <?php endif; ?>>Ayol
                                                </option>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="date" class="form-control" name="begin_at"
                                                   value="<?php echo e(old('begin_at')?old('begin_at'):$data->begin_at); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="command_number"
                                                   value="<?php echo e(old('command_number')?old('command_number'):$data->command_number); ?>">
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="ish_rejimi_id">
                                                        <?php $__currentLoopData = $ish_rejimi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ish_rejimione): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php if(old('ish_rejimi_id') == $ish_rejimione->id || $data->ish_rejimi_id ==$ish_rejimione->id ): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="stavka_id">
                                                        <?php $__currentLoopData = $stavka; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stavkaone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if(old('stavka_id')): ?> <?php if(old('stavka_id') == $stavkaone->id): ?> selected <?php endif; ?> <?php else: ?> <?php if($data->stavka_id == $stavkaone->id): ?> selected <?php endif; ?> <?php endif; ?> value="<?php echo e($stavkaone->id); ?>"><?php echo e($stavkaone->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="position"
                                                   value="<?php echo e(old('position')?old('position'):$data->position); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="room_id">
                                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(old('special_degree_id')): ?> <?php if(old('special_degree_id') == $room_one->id): ?> selected="true" <?php endif; ?> <?php elseif($data->room_id == $room_one->id): ?> selected="true" <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="date" class="form-control" name="end_at"
                                                   value="<?php echo e(old('end_at')?old('end_at'):$data->end_at); ?>">
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="end_command_number"
                                                   value="<?php echo e(old('end_command_number')?old('end_command_number'):$data->end_command_number); ?>">
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="tp_number"
                                                   value="<?php echo e(old('tp_number')?old('tp_number'):$data->tp_number); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="degree_info_id">
                                                <?php $__currentLoopData = $degree_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $degree_info_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('degree_info_id') == $degree_info_one->id || $data->degree_info_id == $degree_info_one->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="academic_degree_id">
                                                <?php $__currentLoopData = $academic_degree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academic_degree_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('academic_degree_id') == $academic_degree_one->id || $data->academic_degree_id == $academic_degree_one->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="degree_id">
                                                <?php $__currentLoopData = $degree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $degree_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('degree_id') == $degree_one->id  || $data->degree_id == $degree_one->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="special_degree_id">
                                                <?php $__currentLoopData = $special_degrees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $special_degrees_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('special_degree_id') == $special_degrees_one->id || $data->special_degree_id == $special_degrees_one->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="partiya_id">
                                                <?php $__currentLoopData = $partiya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partiya_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php if(old('partiya_id') == $partiya_one->id || $data->partiya_id == $partiya_one->id): ?> selected="true"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <textarea style="width: 100%" name="deputat" rows="6"
                                                      cols="33"><?php echo e($data->deputat); ?></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/archive/resources/views/admin/pages/staff/edit.blade.php ENDPATH**/ ?>