...
<body>
    <div class="pre-loader">
        <div class="pre-loader-box">
            <div class="loader-logo"><img src="<?php echo e(asset('assets/admin/vendors/images/deskapp-logo.svg')); ?>" alt=""></div>
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header" style="width: 200px;">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('admin')); ?>">Kirish</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
</html><?php /**PATH C:\wamp64\www\tsul-document\resources\views/test.blade.php ENDPATH**/ ?>