						...
						<table class="table hover data-table-export nowrap">
							...
							<?php endif; ?>
								<tr class="<?php echo e($item->statusclass); ?>">
									<td><?php echo e($i++); ?></td>
									<td><a href="<?php echo e(route('user.show', $item->id)); ?>"><?php echo e($item->getfio()); ?></a></td>
									<td>
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tsul\tsul-archive\tsul-archive\resources\views/mk/pages/user/index.blade.php ENDPATH**/ ?>