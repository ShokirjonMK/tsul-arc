            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="wizard-content">
                        <form autocomplete="off" action="<?php echo e(route('student.update',['student'=>$data->id])); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="country_id">
                                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if(old('country_id') == $country->id || $country->code == 'UZ' || $data->country_id == $country->id ): ?> selected <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <select class="form-control" name="region_id">
                                                        <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option <?php if((old('region_id') == $region->id) || ($data->region_id == $region->id)): ?> selected <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input class="form-control" name="enter_year" min="1980"
                                                value="<?php if(old('enter_year')): ?><?php echo e(old('enter_year')); ?><?php else: ?><?php echo e($data->enter_year); ?><?php endif; ?>"
                                                max="<?php echo e($this_year); ?>"
                                                type="number" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input class="form-control" name="enter_order"
                                                value="<?php if(old('enter_order')): ?><?php echo e(old('enter_order')); ?><?php else: ?><?php echo e($data->enter_order); ?><?php endif; ?>" type="text" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input class="form-control" name="enter_order_date"
                                                value="<?php if(old('enter_order_date')): ?><?php echo e(old('enter_order_date')); ?><?php else: ?><?php echo e($data->enter_order_date); ?><?php endif; ?>" type="date" />
                                        </div>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="faculty_id">
                                                <?php $__currentLoopData = $faculty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if($data->faculty_id == $faculty_one->id): ?> selected <?php endif; ?> value="<?php echo e($faculty_one->id); ?>"><?php echo e($faculty_one->name); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="edu_form_id">
                                                <?php $__currentLoopData = $edu_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu_form_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if((old('degree_id') == $edu_form_one->id) || ($data->edu_form_id == $edu_form_one->id)): ?> selected="true" <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="is_contract">
                                                <option <?php if((old('degree_id') == 0) || ($data->is_contract == 0) ): ?> selected="true" <?php endif; ?> value="0">Grant
                                                </option>
                                                <option <?php if(old('degree_id') == 1 || ($data->is_contract == 1) ): ?> selected="true" <?php endif; ?> value="1">
                                                    Kontarkt </option>
                                            </select>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input class="form-control" name="graduated_year" min="1980"
                                                value="<?php if(old('graduated_year')): ?><?php echo e(old('graduated_year')); ?><?php else: ?><?php echo e($data->graduated_year); ?><?php endif; ?>" max="<?php echo e($this_year); ?>"
                                                type="number" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="j-flex">
                                                ...
                                                <input type="text" id="graduated_order" class="form-control "
                                                    ...
                                                    value="<?php if(old('graduated_order')): ?><?php echo e(old('graduated_order')); ?><?php else: ?><?php echo e($data->graduated_order); ?><?php endif; ?>">
                                                <input type="date" id="graduated_order_date" class="form-control "
                                                    style="width: 68%" name="graduated_order_date"
                                                    value="<?php if(old('graduated_order_date')): ?><?php echo e(old('graduated_order_date')); ?><?php else: ?><?php echo e($data->graduated_order_date); ?><?php endif; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="edu_type_id">
                                                <?php $__currentLoopData = $edu_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu_type_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if((old('degree_id') == $edu_type_one->id) || ($data->edu_type_id == $edu_type_one->id)): ?> selected="true" <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="document_type"
                                                value="<?php if(old('document_type')): ?><?php echo e(old('document_type')); ?><?php else: ?><?php echo e($data->document_type); ?><?php endif; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="ilova"
                                                value="<?php if(old('ilova')): ?><?php echo e(old('ilova')); ?><?php else: ?><?php echo e($data->ilova); ?><?php endif; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="sinov_daftarchasi"
                                                value="<?php if(old('sinov_daftarchasi')): ?><?php echo e(old('sinov_daftarchasi')); ?><?php else: ?><?php echo e($data->sinov_daftarchasi); ?><?php endif; ?>">
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="topografiya_nomeri"
                                                value="<?php if(old('topografiya_nomeri')): ?><?php echo e(old('topografiya_nomeri')); ?><?php else: ?><?php echo e($data->topografiya_nomeri); ?><?php endif; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="royhat_raqami"
                                                value="<?php if(old('royhat_raqami')): ?><?php echo e(old('royhat_raqami')); ?><?php else: ?><?php echo e($data->royhat_raqami); ?><?php endif; ?>">
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <select class="form-control" name="room_id">
                                                <?php $__currentLoopData = $room; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room_one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if((old('room_id') == $room_one->id) || ($data->room_id == $room_one->id )): ?> selected="true" <?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function get_regions() {
            ...
            var data_area = '<?php echo e($data->area_id); ?>';
    ...
    <script type="text/javascript">
        ...
        function get_countrys() {
            ...
            var data_region = '<?php echo e($data->region_id); ?>';
    ...
    <script type="text/javascript">
        ...
        function get_directions() {
            var old_direction = '<?php echo e(old('direction_id')); ?>';
            var data_direction = '<?php echo e($data->direction_id); ?>';
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tsul\tsul-archive\tsul-archive\resources\views/mk/pages/student/editstd.blade.php ENDPATH**/ ?>