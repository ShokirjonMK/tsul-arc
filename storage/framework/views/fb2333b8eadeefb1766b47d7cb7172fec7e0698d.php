...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="faculty"
                                                   value="<?php if(old('faculty')): ?><?php echo e(old('faculty')); ?><?php else: ?><?php echo e($data->faculty); ?><?php endif; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <input type="text" class="form-control" name="direction"
                                                   value="<?php if(old('direction')): ?><?php echo e(old('direction')); ?><?php else: ?><?php echo e($data->direction); ?><?php endif; ?>">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
...
<?php echo $__env->make('mk.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/archive/resources/views/mk/pages/student/editstd.blade.php ENDPATH**/ ?>