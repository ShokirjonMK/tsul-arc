        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="row clearfix progress-box">
                <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                    <div class="card-box pd-30 height-100-p">
                        <div class="progress-box text-center">
                            <input type="text" class="knob dial1" value="<?php echo e($jami_xodimlar); ?>" data-width="100"
                                data-height="100" data-linecap="round" data-thickness="0.12" data-bgColor="#fff"
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                    <div class="card-box pd-30 height-100-p">
                        <div class="progress-box text-center">
                            <input type="text" class="knob dial2" value="<?php echo e($teacher_xodimlar); ?>" data-width="100"
                                data-height="100" data-linecap="round" data-thickness="0.12" data-bgColor="#fff"
                                data-fgColor="#00e091" data-angleOffset="180" readonly>
                            <h5 class="text-light-green padding-top-10 h5">O'qituvchilar</h5>
                            <span class="d-block"> <?php echo e($all_teacher); ?> <i
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                    <div class="card-box pd-30 height-100-p">
                        <div class="progress-box text-center">
                            <input type="text" class="knob dial3" value="<?php echo e($free_shtat_f); ?>" data-width="100"
                                data-height="100" data-linecap="round" data-thickness="0.12" data-bgColor="#fff"
                                data-fgColor="#f56767" data-angleOffset="180" readonly>
                            <h5 class="text-light-orange padding-top-10 h5">Bo'sh ish o'rinlari</h5>
                            <span class="d-block"> <?php echo e($free_shtat); ?> <i
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                    <div class="card-box pd-30 height-100-p">
                        <div class="progress-box text-center">
                            <input type="text" class="knob dial4" value="<?php echo e($inner_shtat_f); ?>" data-width="100"
                                data-height="100" data-linecap="round" data-thickness="0.12" data-bgColor="#fff"
                            ...
                            <span class="d-block"> <?php echo e($inner_shtat); ?> | <?php echo e($outer_shtat); ?> <i
                        ...
                        <div class="browser-visits">
                            <ul>
                                <li class="d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="visit"><span class="badge badge-pill badge-primary"><?php echo e($prof_count); ?> |
                                            <?php echo e($dot_count); ?></span></div>
                                </li>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <i style="color: #1b00ff;" class="icon-copy fa fa-user-circle-o"
                                            aria-hidden="true"></i>
                                    </div>
                                    <div class="browser-name">Fan nomzod | doktorlari soni</div>
                                    <div class="visit"><span class="badge badge-pill badge-secondary"><?php echo e($cond_count); ?> |
                                            <?php echo e($doc_count); ?></span></div>
                                </li>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                    ...
                                    <div class="visit"><span
                                            class="badge badge-pill badge-success"><?php echo e($darajasiz_count); ?> |
                                            <?php echo e($darajasiz_count1); ?></span></div>
                                </li>
                                <hr>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                    ...
                                    <div class="visit"><span
                                            class="badge badge-pill badge-warning"><?php echo e($adliya_count); ?></span></div>
                                </li>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                    ...
                                    <div class="visit"><span
                                            class="badge badge-pill badge-info"><?php echo e($unvonli_count); ?></span></div>
                                </li>
                                <li class="d-flex flex-wrap align-items-center">
                                    <div class="icon">
                                        <i style="color: #1b00ff;" class="icon-copy ion-ionic"></i>
                                    ...
                                    <div class="visit"><span
                                            class="badge badge-pill badge-info"><?php echo e($unvonsiz_count); ?></span></div>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $({
            ...
            animatedVal: <?php echo e($jami_xodimlar); ?>
        ...
        $({
            ...
            animatedVal: <?php echo e($teacher_xodimlar); ?>
        ...
        $({
            ...
            animatedVal: <?php echo e($free_shtat_f); ?>
        ...
        $({
            ...
            animatedVal: <?php echo e($inner_shtat_f); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tsul\tsul-archive\tsul-archive\resources\views/admin/index.blade.php ENDPATH**/ ?>