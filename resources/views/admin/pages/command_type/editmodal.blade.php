<div class="modal fade bs-example-modal-lg" id="editmodal{{$item->id}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('command-type.update' , ['command_type' => $item->id])}}" method="post"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input required="true" class="form-control" type="text" name="name" value="{{$item->name}}"
