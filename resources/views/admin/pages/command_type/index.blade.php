...
@section('content')
                    ...
                    <div class="pb-20">
                        ...
                        <table class="table hover  data-table-export nowrap">
                            ...
                            @foreach($data as $item)
                                <tr class="@if($item->status==1) table-success @else table-secondary @endif">
                                    ...
                                    <td>
                                        ...
                                        <a class="p-2" href="#" data-toggle="modal"
                                           data-target="#editmodal{{$item->id}}"><i class="dw dw-edit2"></i></a>
                                ...
                                @include('admin.pages.command_type.delete')
                                {{--								@include('admin.pages.department.modal')--}}
                                @include('admin.pages.command_type.editmodal')
                            @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    @include('admin.pages.command_type.createmodal')
