            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="wizard-content">
                        <form autocomplete="off" action="{{ route('staff.update',['staff'=>$data->id]) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="country_id">
                                                        @foreach($countries as $country)
                                                            <option
                                                                @if((old('country_id') == $country->id) || $data->counrty_id == $country->id || ($country->code == "UZ")) selected
                                                                @endif value="{{ $country->id }} e">{{ $country->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="region_id">
                                                        @foreach($regions as $region)
                                                            <option
                                                                @if(old('region_id') == $region->id || $data->region_id == $region->id) selected
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="birth_address" type="text"
                                                   value="{{old('birth_address')?old('birth_address'):$data->birth_address}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="nationality_id">
                                                @foreach($nationalities as $nationality)
                                                    <option
                                                        @if(old('nationality_id') == $nationality->id || $data->nationality_id == $nationality->id) selected="true"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="gender">
                                                ...
                                                <option value="1" @if($data->gender==1) selected="true" @endif>Erkak
                                                </option>
                                                <option value="0" @if($data->gender==0) selected="true" @endif>Ayol
                                                </option>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="begin_at"
                                                   value="{{old('begin_at')?old('begin_at'):$data->begin_at}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><span>*</span>Buyruq raqami :
                                                <span class="error">
															@error('command_number')
                                                    {{ $message }}
                                                    @enderror
														</span>
                                            </label>
                                            <input type="text" class="form-control" name="command_number"
                                                   value="{{old('command_number')?old('command_number'):$data->command_number}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="ish_rejimi_id">
                                                        @foreach($ish_rejimi as $ish_rejimione)
                                                            <option
                                                                @if(old('ish_rejimi_id') == $ish_rejimione->id || $data->ish_rejimi_id ==$ish_rejimione->id ) selected="true"
                                                                @endif value="{{ $ish_rejimione->id }}">{{ $ish_rejimione->name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="stavka_id">
                                                        @foreach($stavka as $stavkaone)
                                                            <option @if(old('stavka_id')) @if(old('stavka_id') == $stavkaone->id) selected @endif @else @if($data->stavka_id == $stavkaone->id) selected @endif @endif value="{{ $stavkaone->id }}">{{ $stavkaone->name }}</option>
                                                        @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="position"
                                                   value="{{old('position')?old('position'):$data->position}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="room_id">
                                                @foreach ($rooms as $room_one)
                                                    <option @if (old('special_degree_id')) @if(old('special_degree_id') == $room_one->id) selected="true" @endif @elseif($data->room_id == $room_one->id) selected="true" @endif
                                                    value="{{ $room_one->id }}">
                                            ...
                                            {{--														</span>--}}
                                            {{--													</label>--}}
                                            {{--                                                    <input type="date" class="form-control" name="command_date" value="{{old('command_date')?old('command_date'):$data->command_date}}">--}}
                                            {{--												</div>--}}
                                            {{--											</div>--}}
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="end_at"
                                                   value="{{old('end_at')?old('end_at'):$data->end_at}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><span>*</span>Buyruq raqami :
                                                <span class="error">
															@error('end_command_number')
                                                    {{ $message }}
                                                    @enderror
														</span>
                                            </label>
                                            <input type="text" class="form-control" name="end_command_number"
                                                   value="{{old('end_command_number')?old('end_command_number'):$data->end_command_number}}">
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tp_number"
                                                   value="{{old('tp_number')?old('tp_number'):$data->tp_number}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="degree_info_id">
                                                @foreach($degree_info as $degree_info_one)
                                                    <option
                                                        @if(old('degree_info_id') == $degree_info_one->id || $data->degree_info_id == $degree_info_one->id) selected="true"
                                                        @endif value="{{ $degree_info_one->id }}">{{ $degree_info_one->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="academic_degree_id">
                                                @foreach($academic_degree as $academic_degree_one)
                                                    <option
                                                        @if(old('academic_degree_id') == $academic_degree_one->id || $data->academic_degree_id == $academic_degree_one->id) selected="true"
                                                        @endif value="{{ $academic_degree_one->id }}">{{ $academic_degree_one->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="degree_id">
                                                @foreach($degree as $degree_one)
                                                    <option
                                                        @if(old('degree_id') == $degree_one->id  || $data->degree_id == $degree_one->id) selected="true"
                                                        @endif value="{{ $degree_one->id }}">{{ $degree_one->name }}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="special_degree_id">
                                                @foreach($special_degrees as $special_degrees_one)
                                                    <option
                                                        @if(old('special_degree_id') == $special_degrees_one->id || $data->special_degree_id == $special_degrees_one->id) selected="true"
                                                        @endif value="{{ $special_degrees_one->id }}">{{ $special_degrees_one->name }}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="partiya_id">
                                                @foreach($partiya as $partiya_one)
                                                    <option
                                                        @if(old('partiya_id') == $partiya_one->id || $data->partiya_id == $partiya_one->id) selected="true"
                                                        @endif value="{{ $partiya_one->id }}">{{ $partiya_one->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <textarea style="width: 100%" name="deputat" rows="6"
                                                      cols="33">{{$data->deputat}}</textarea>
                                        </div>
                                    </div>
