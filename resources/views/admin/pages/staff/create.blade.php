            ...
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="wizard-content">
                        <form autocomplete="off" action="{{ route('staff.store') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="region_id">
                                                        @foreach($regions as $region)
                                                            <option @if(old('region_id') == $region->id) selected
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="nationality_id">
                                                @foreach($nationalities as $nationality)
                                                    <option
                                                        @if(old('nationality_id') == $nationality->id) selected="true"
                                ...
                                <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="ish_rejimi_id">
                                                        @foreach($ish_rejimi as $ish_rejimione)
                                                            <option
                                                                @if(old('ish_rejimi_id') == $ish_rejimione->id ) selected="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="stavka_id">
                                                        @foreach($stavka as $stavkaone)
                                                            <option
                                                                @if(old('stavka_id') == $stavkaone->id || $stavkaone->name == 1) selected="true"
                                                                @endif value="{{ $stavkaone->id }}">{{ $stavkaone->name }}</option>
                                                        @endforeach
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{--														</span>--}}
                                            {{--													</label>--}}
                                            {{--                                                    <input type="date" class="form-control" name="command_date" value="{{old('command_date')}}">--}}
                                            {{--												</div>--}}
                                            {{--											</div>--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="degree_info_id">
                                                @foreach($degree_info as $degree_info_one)
                                                    <option
                                                        @if(old('degree_info_id') == $degree_info_one->id ) selected="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="academic_degree_id">
                                                @foreach($academic_degree as $academic_degree_one)
                                                    <option
                                                        @if(old('academic_degree_id') == $academic_degree_one->id ) selected="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="degree_id">
                                                @foreach($degree as $degree_one)
                                                    <option @if(old('degree_id') == $degree_one->id ) selected="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="special_degree_id">
                                                @foreach($special_degrees as $special_degrees_one)
                                                    <option
                                                        @if(old('special_degree_id') == $special_degrees_one->id ) selected="true"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="partiya_id">
                                                @foreach($partiya as $partiya_one)
                                                    <option @if(old('partiya_id') == $partiya_one->id ) selected="true"
