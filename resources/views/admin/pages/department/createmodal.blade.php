						...
						<div class="modal-body">
							<form  action="{{route('department.store')}}" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<div class="col-sm-12 col-md-10">
										<select class="selectpicker form-control" name="parent_id" data-style="btn-outline-primary">
											...
											<option @if($selitem->status !=1 ) disabled @endif value="{{$selitem->id}}">{{$selitem->name}}</option>
											@endforeach
										</select>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-12 col-md-3" style="height: 44px;">
										<input  required="true" class="form-control" placeholder="Vaqti" min="2013-01-01" max="{{$date}}" name="order_date" value=""  type="date">
									</div>
